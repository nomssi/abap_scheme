...
public section.
*"* public components of class ZCL_LISP_AREA
*"* do not include other source files here!!!

  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_LISP_AREA'. "#EC NOTEXT
  ...
  methods GET_ROOT
    redefinition .
protected section.
*"* protected components of class ZCL_LISP_AREA
*"* do not include other source files here!!!
private section.
*"* private components of class ZCL_LISP_AREA
*"* do not include other source files here!!!
