...
After reading Conrad Barski's <a href="http://landoflisp.com/">Land of Lisp</a> I was curious to understand Martin Ceronio's <a href="https://blogs.sap.com/2015/06/24/a-lisp-interpreter-in-abap/">LISP interpreter in ABAP</a>. This is my [Make a Lisp](https://github.com/kanaka/mal/blob/master/process/guide.md) learning project that started as a fork of https://github.com/mydoghasworms/abap-lisp.

I converted the regression tests to ABAP Unit, added validations, an editor and many [Scheme](http://www.r7rs.org/) features but I won't call this _LISP interpreter with ABAP integration_ a _Scheme_ until issue #1 is resolved.
