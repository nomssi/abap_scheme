...
So this is my learning project that started as a fork of https://github.com/mydoghasworms/abap-lisp, itself inspired by [Peter Norvig](http://norvig.com/lispy2.html). You can [Make your own Lisp](https://github.com/kanaka/mal/blob/master/process/guide.md) too.

My contributions 
- more validations, the code should be stable
...
- I won't call this LISP interpreter a _Scheme_ until issue #1 is resolved.
